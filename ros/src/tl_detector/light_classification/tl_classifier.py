...
class TLClassifier(object):
    def __init__(self):
        ...
        ssd_inception_sim_model = os.path.join(dir_path, 'frozen_models/frozen_bosch_real/frozen_inference_graph.pb')
        PATH_TO_LABELS = os.path.join(dir_path, 'tl/label_map.pbtxt')
        # rospy.loginfo(PATH_TO_LABELS)
        NUM_CLASSES = 4
        
        #rospy.logwarn(os.getcwd())
        #rospy.logwarn(os.path.dirname(os.path.abspath(__file__)))
